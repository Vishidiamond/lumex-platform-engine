...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://lumexconstellation.com/lumex-logo.png" },
      { name: "twitter:image", content: "https://lumexconstellation.com/lumex-logo.png" },
      { name: "theme-color", content: "#070b18" },
    ],
    links: [
      { rel: "icon", type: "image/png", href: "/lumex-logo.png" },
      { rel: "apple-touch-icon", href: "/lumex-logo.png" },
